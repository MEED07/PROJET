...
$query = "SELECT * FROM produit WHERE id_categorie = 15";
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="display: flex; align-items: flex-start;">
            ...
            <div class="product-info">
                ...
                <p><strong>Price:</strong> 300$<span id="modal-product-price" class="modal-product-price"></span></p>
                <p><strong>Year:</strong>2024 <span id="modal-product-year" class="modal-product-year"></span></p>
                <p></strong> <span id="modal-product-processor" class="modal-product-processor"></span></p>
                <p></strong> <span id="modal-product-camera" class="modal-product-camera"></span></p>
